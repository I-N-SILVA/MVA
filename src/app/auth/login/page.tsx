          ...
          <div className="flex flex-col justify-center px-12">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold mb-1">Scout Athletes</h3>
                  <p className="text-blue-100">Submit promising athletes for community validation</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold mb-1">Community Validation</h3>
                  <p className="text-blue-100">Vote on submissions and help identify future stars</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold mb-1">Invest & Earn</h3>
                  <p className="text-blue-100">Invest in approved athletes and earn from their success</p>
                </div>
              </div>
            </div>
          </div>
